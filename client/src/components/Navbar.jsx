        ...
        {user ? (
          <div className="flex items-center gap-2 sm:gap-4 md:gap-6 lg:gap-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <div
                ref={menuRef}
                className="py-2 cursor-pointer text-base flex items-center gap-4 relative"
              >
                <img
                  src={assets.profile_icon}
                  alt="Profile icon"
          ...
          <div className="flex gap-2 sm:gap-6 lg:gap-8 items-center">
            ...
            <button
              onClick={() => handleClick()}
              className="bg-zinc-800 px-4 py-1 sm:px-12 sm:py-2 rounded-full cursor-pointer text-base sm:text-lg text-white"
            >
              Login
            </button>
          </div>
